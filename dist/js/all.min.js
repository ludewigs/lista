angular.module("listaTelefonica",["ngRoute","ngMessages","serialGenerator","ui"]),angular.module("listaTelefonica").factory("nomeApp",function(){return{name:"Lista Telefônica"}});
/*
 AngularJS v1.4.9
...
angular.module("listaTelefonica").config(["$routeProvider",function(t){t.when("/contatos",{templateUrl:"view/contatos.htm",controller:"listaTelefonicaCtrl"}).when("/novoContato",{templateUrl:"view/novoContato.htm",controller:"novoContatoCtrl",resolve:{operadoras:function(t){return t.getOperadoras()}}}).when("/detalhesContato/:id",{templateUrl:"view/detalhesContato.htm",controller:"detalhesContatoCtrl",resolve:{contato:function(t,o){return t.getContato(o.current.params.id)}}}).otherwise({redirectTo:"/contatos"})}]);
/*
 AngularJS v1.4.9
 (c) 2010-2015 Google, Inc. http://angularjs.org
 License: MIT
...
angular.module("listaTelefonica").config(["serialGeneratorProvider",function(e){e.setLength(5)}]);
/*
 AngularJS v1.4.9
 (c) 2010-2015 Google, Inc. http://angularjs.org
 License: MIT
...
angular.module("listaTelefonica").controller("detalhesContatoCtrl",["$scope","nomeApp","$routeParams","contato",function(a,o,t,e){a.appName=o.name,a.contato=e.data}]);
angular.module("listaTelefonica").controller("listaTelefonicaCtrl",["$scope","nomeApp","contatosAPI","serialGenerator",function(o,n,e,t){o.appName=n.name;var r=function(){e.getContatos().success(function(n){o.contatos=n}).error(function(n,e){o.error="Não foi possível carregar os dados!"})};o.apagarContatos=function(n){o.contatos=n.filter(function(o){return o.selecionado?void 0:o})},o.isContatoSelecionado=function(o){return o?o.some(function(o){return o.selecionado}):void 0},o.ordenarPor=function(n){o.ordem=n,o.sentido=!o.sentido},r()}]);
angular.module("listaTelefonica").controller("novoContatoCtrl",["$scope","$location","nomeApp","contatosAPI","operadorasAPI","serialGenerator","operadoras",function(o,a,t,e,n,r,s){o.operadoras=s.data,o.appName=t.name,o.adicionarContato=function(t){t.serial=r.generate(),t.data=new Date,e.saveContato(t).success(function(t){delete o.contato,o.contatoForm.$setPristine(),a.path("/contatos")})}}]);
angular.module("listaTelefonica").directive("uiAlert",function(){return{templateUrl:"view/alert.htm",replace:!0,restrict:"AE",scope:{title:"@"},transclude:!0}});
angular.module("listaTelefonica").directive("uiDate",["$filter",function(e){return{require:"ngModel",link:function(n,t,r,i){var u=function(e){return"undefined"==typeof e?e:(e=e.replace(/\D/g,""),e.length>=2&&(e=e.substring(0,2)+"/"+e.substring(2)),e.length>=5&&(e=e.substring(0,5)+"/"+e.substring(5,9)),e)};t.bind("keyup",function(){i.$setViewValue(u(i.$viewValue)),i.$render()}),i.$parsers.push(function(e){if(10===e.length){var n=e.split("/");return new Date(n[2],n[1]-1,n[0]).getTime()}}),i.$formatters.push(function(n){return e("date")(n,"dd/MM/yyyy")})}}}]);
angular.module("listaTelefonica").filter("ellipsis",function(){return function(n,r){if(n.length<=r)return n;var e=n.substring(0,r||5)+"...";return e}});
angular.module("listaTelefonica").filter("name",function(){return function(e){var t=e.split(" "),n=t.map(function(e){return/^(da|e|de|do|dos|das)$/i.test(e)?e.toLowerCase():e.charAt(0).toUpperCase()+e.substring(1).toLowerCase()});return n.join(" ")}});
angular.module("listaTelefonica").factory("contatosAPI",["$http","backend",function(t,n){var o=function(){return t.get(n.baseUrl+"/contatos")},a=function(o){return t.get(n.baseUrl+"/contatos/"+o)},e=function(o){return t.post(n.baseUrl+"/contatos",o)};return{getContatos:o,getContato:a,saveContato:e}}]);
angular.module("listaTelefonica").service("operadorasAPI",["$http","backend",function(e,a){this.getOperadoras=function(){return e.get(a.baseUrl+"/operadoras")}}]);
angular.module("listaTelefonica").value("backend",{baseUrl:"http://localhost:3412"});
angular.module("serialGenerator",[]),angular.module("serialGenerator").provider("serialGenerator",function(){var r=10;this.getLength=function(){return r},this.setLength=function(e){r=e},this.$get=function(){return{generate:function(){for(var e="";e.length<r;)e+=String.fromCharCode(Math.floor(89*Math.random())+33);return e}}}});
angular.module("ui",[]),angular.module("ui").run(["$templateCache",function(i){i.put("view/accordion.htm",'<div class="ui-accordion-title" ng-click="open(this.$id)">{{ title }}</div><div class="ui-accordion-content" ng-transclude ng-show="isOpen"></div>')}]),angular.module("ui").directive("uiAccordions",function(){return{controller:function(i,n,c){var e=[];this.registerAccordion=function(i){e.push(i)},this.closeAll=function(i){e.map(function(n){i===n.$id?n.$id.isOpen=!1:n.isOpen=!1})}}}}),angular.module("ui").directive("uiAccordion",function(){return{templateUrl:"view/accordion.htm",transclude:!0,scope:{title:"@"},require:"^uiAccordions",link:function(i,n,c,e){e.registerAccordion(i),i.open=function(n){e.closeAll(n),i.isOpen=!i.isOpen}}}});